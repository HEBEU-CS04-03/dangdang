            ...
            $('#Exit_system').on('click', function () {
                layer.confirm('是否确定退出系统？', {
                    ...
                    function () {
                		...
                		parent.location = "${pageContext.request.contextPath}/admin/logout.action";
                ...
                <li class="light-blue">
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                       <!-- 
                        ...
                        <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath}/admin/findAdminById?aId=${admin.aId}" class="iframeurl"><i class="icon-user"></i>个人资料</a></li>
                        <li class="divider"></li>
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list" id="nav_list">
                <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath}/page/toHome"
                ...
                <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span
                        class="menu-text"> 图书分类管理 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                        <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath}/admin/selectBookType" title="产品类表"
                                            class="iframeurl"><i class="icon-double-angle-right"></i> 图书分类列表 </a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="submenu">
                        <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath}/seller/order?method=orderPassList" title="接单列表"
                                            class="iframeurl"><i class="icon-double-angle-right"></i>接单列表</a></li>
                        <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath}/seller/order?method=orderList" title="订单列表"
                                            class="iframeurl"><i class="icon-double-angle-right"></i>订单列表</a></li>
                    </ul>
                </li>
                <li><a href="#" class="dropdown-toggle"><i class="icon-group"></i><span class="menu-text"> 个人管理 </span><b
                        class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                        <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath}/seller/shop?method=shopInfo" title="店铺信息"
                                            class="iframeurl"><i class="icon-double-angle-right"></i>店铺信息</a></li>
                    </ul>
                </li>
            </ul>
        ...
        <div class="main-content">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li>
                        ...
                        <a href="${pageContext.request.contextPath}/page/toIndex">首页</a>
                    </li>
            ...
            <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;" name="iframe" frameborder="0"
                    src="${pageContext.request.contextPath}/page/toHome"></iframe>
...
<div class="footer_style" id="footerstyle">
    <p class="l_f">版权所有：计算机1604第三组</p>
    <p class="r_f">小组成员：言立慧 雷宇飞 王慧 贺海洋 田梓钊 王煜</p>
</div>
<!--修改密码样式-->
