...
<body>
    <div style="width: 80%;margin: 20px auto">
        <form id="dishAddId"  method="post" action="${pageContext.request.contextPath}/admin/addBookType">
            <div class="col-lg-6 form-group">
                <input type="text" style="width: 60%"  class="form-control" name="tId" placeholder="分类编号">
            </div>
            <div class="col-lg-6 form-group">
                <input type="text" style="width: 60%"   class="form-control" name="tType" placeholder="分类名称">
            </div>
