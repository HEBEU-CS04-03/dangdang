...
<div class="clearfix">
    <div class="admin_info_style">
        <div class="admin_modify_style" id="Personal">
            ...
            <form id="book_form" action="/adminBook/addBook" method="post" enctype="multipart/form-data">
                <div class="xinxi">
                    ...
                    <div class="form-group"><label class="col-sm-3 control-label no-padding-right">书籍图片</label>
                        <div class="img-responsive">
                            <c:if test="${book != null}">
                                <img src="${pageContext.request.contextPath}/static/images/${book.bImage}" alt=""/>
                            </c:if>
                            <c:if test="${book == null}">
