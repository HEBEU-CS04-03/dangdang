...
<div id="booktop">
    <div class="widthmid">
            <span id="nickname1">你好,<a dd_name="欢迎" href="${pageContext.request.contextPath}/customer/showCustomer" target="_self"
                                      rel="nofollow"
                                      class="login_link">${customer.cName}</a>请修改个人信息</span>
            <span id="nickname2">&nbsp;&nbsp;<a dd_name="退出登录" href="${pageContext.request.contextPath}/customer/loginOut">退出登录</a></span>
        <ul class="topbox">
            <li class="boxlia">
...
<form action="${pageContext.request.contextPath}/customer/updateCustomer" method="post" >
    ...
    <dl class="login_content">
        <dd>用户电话修改：<input id="phone" type="text" class="login_content_input" value="${customer.cPhone}" name="cPhone"></dd>
    </dl>
    <dl class="login_content">
        <dd>用户邮箱修改：<input id="email" type="text" class="login_content_input" value="${customer.cEmail}" name="cEmail"></dd>
    </dl>
    <dl class="login_content">
        <dd>用户地址修改：<input id="address" type="text" class="login_content_input" value="${customer.cAddress}" name="cAddress"></dd>
    </dl>
    <dl class="login_content">
        <dd>用户密码修改：<input id="password0" type="password" class="login_content_input" value="${customer.cPass}" name="cPass">
    ...
    <dl class="login_content">
        <dt></dt>
        <dd><input onclick="pwdCompare2()" id="btn" value="确认修改" type="submit" class="login_btn_out"  onmouseover="this.className='login_btn_over'"  onmouseout="this.className='login_btn_out'"></dd>
    </dl>
</form>
    </div>
</body>
